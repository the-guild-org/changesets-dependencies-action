  ...
  "node_modules/@actions/http-client/lib/index.js"(exports) {
    ...
    var HttpClient = class {
      ...
      getJson(requestUrl, additionalHeaders = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          additionalHeaders[Headers3.Accept] = this._getExistingOrDefaultHeader(additionalHeaders, Headers3.Accept, MediaTypes.ApplicationJson);
      ...
      postJson(requestUrl, obj, additionalHeaders = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          additionalHeaders[Headers3.Accept] = this._getExistingOrDefaultHeader(additionalHeaders, Headers3.Accept, MediaTypes.ApplicationJson);
          additionalHeaders[Headers3.ContentType] = this._getExistingOrDefaultHeader(additionalHeaders, Headers3.ContentType, MediaTypes.ApplicationJson);
...
// node_modules/@octokit/request/node_modules/webidl-conversions/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/@octokit/request/node_modules/webidl-conversions/lib/index.js"(exports, module2) {
    "use strict";
    var conversions = {};
...
// node_modules/@octokit/request/node_modules/whatwg-url/lib/utils.js
var require_utils3 = __commonJS({
  "node_modules/@octokit/request/node_modules/whatwg-url/lib/utils.js"(exports, module2) {
    "use strict";
...
// node_modules/@octokit/request/node_modules/tr46/lib/mappingTable.json
var require_mappingTable = __commonJS({
  "node_modules/@octokit/request/node_modules/tr46/lib/mappingTable.json"(exports, module2) {
...
// node_modules/@octokit/request/node_modules/tr46/index.js
var require_tr46 = __commonJS({
  "node_modules/@octokit/request/node_modules/tr46/index.js"(exports, module2) {
    "use strict";
...
// node_modules/@octokit/request/node_modules/whatwg-url/lib/url-state-machine.js
var require_url_state_machine = __commonJS({
  "node_modules/@octokit/request/node_modules/whatwg-url/lib/url-state-machine.js"(exports, module2) {
    "use strict";
    var punycode = require("punycode");
...
// node_modules/@octokit/request/node_modules/whatwg-url/lib/URL-impl.js
var require_URL_impl = __commonJS({
  "node_modules/@octokit/request/node_modules/whatwg-url/lib/URL-impl.js"(exports) {
    "use strict";
...
// node_modules/@octokit/request/node_modules/whatwg-url/lib/URL.js
var require_URL = __commonJS({
  "node_modules/@octokit/request/node_modules/whatwg-url/lib/URL.js"(exports, module2) {
    "use strict";
...
// node_modules/@octokit/request/node_modules/whatwg-url/lib/public-api.js
var require_public_api = __commonJS({
  "node_modules/@octokit/request/node_modules/whatwg-url/lib/public-api.js"(exports) {
    "use strict";
...
var require_utils4 = __commonJS({
  "node_modules/@actions/github/lib/utils.js"(exports) {
    ...
    var core_1 = (init_dist_web9(), __toCommonJS(dist_web_exports));
    var plugin_rest_endpoint_methods_1 = (init_dist_web10(), __toCommonJS(dist_web_exports2));
    var plugin_paginate_rest_1 = (init_dist_web11(), __toCommonJS(dist_web_exports3));
    ...
    function patch(fs3) {
      ...
      function patchLutimes(fs4) {
        if (constants.hasOwnProperty("O_SYMLINK")) {
          ...
          fs4.lutimes = function(_a4, _b, _c, cb) {
            if (cb)
              process.nextTick(cb);
          };
...
Body2.prototype.buffer = (0, import_node_util.deprecate)(Body2.prototype.buffer, "Please use 'response.arrayBuffer()' instead of 'response.buffer()'", "node-fetch#buffer");
...
var extractContentType2 = (body, request2) => {
  if (body === null) {
    return null;
  }
  ...
  if (body instanceof FormData) {
    return `multipart/form-data; boundary=${request2[INTERNALS2].boundary}`;
  }
...
var getTotalBytes2 = (request2) => {
  const { body } = request2[INTERNALS2];
  if (body === null) {
    return 0;
  }
  if (isBlob2(body)) {
...
var writeToStream2 = async (dest, { body }) => {
  if (body === null) {
    dest.end();
  } else {
...
var Request2 = class extends Body2 {
  ...
  get url() {
    return (0, import_node_url.format)(this[INTERNALS4].parsedURL);
  }
  get headers() {
...
var getNodeRequestOptions2 = (request2) => {
  const { parsedURL } = request2[INTERNALS4];
  const headers = new Headers2(request2[INTERNALS4].headers);
  if (!headers.has("Accept")) {
    headers.set("Accept", "*/*");
  }
  let contentLengthValue = null;
  ...
  if (request2.referrer && request2.referrer !== "no-referrer") {
    request2[INTERNALS4].referrer = determineRequestsReferrer(request2);
  } else {
    request2[INTERNALS4].referrer = "no-referrer";
  }
  if (request2[INTERNALS4].referrer instanceof URL) {
...
async function fetch2(url, options_) {
  return new Promise((resolve, reject) => {
    ...
    const { parsedURL, options } = getNodeRequestOptions2(request2);
    ...
    request_.on("error", (error) => {
      reject(new FetchError2(`request to ${request2.url} failed, reason: ${error.message}`, "system", error));
      finalize();
    });
        ...
        switch (request2.redirect) {
          ...
          case "follow": {
            ...
            const requestOptions = {
              ...
              compress: request2.compress,
              method: request2.method,
              body: clone2(request2),
              signal: request2.signal,
              size: request2.size,
              referrer: request2.referrer,
              referrerPolicy: request2.referrerPolicy
            };
            if (!isDomainOrSubdomain3(request2.url, locationURL) || !isSameProtocol(request2.url, locationURL)) {
              for (const name of ["authorization", "www-authenticate", "cookie", "cookie2"]) {
    ...
    writeToStream2(request_, request2).catch(reject);
  });
}
...
// src/index.ts
async function fetchFile(pat, file) {
  return await fetch2(
...
async function fetchJsonFile(pat, file) {
  return await fetchFile(pat, file).then((x2) => x2.json()).catch(() => null);
}
(async () => {
    ...
    const filesContent = await Promise.all(
      filesToScan.map(async (filePath) => {
        try {
          ...
          console.warn(`Failed to fetch package.json file: ${filePath}`, e2);
          return null;
        }
      })
    );
